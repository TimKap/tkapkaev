            ...
            <form>
                <div class="d-flex flex-row">
                    <div class="p-2"><input type='submit' class="btn btn-primary" value='Выход'
                                            ...
                                            formmethod='post'></div>
                    <div class="p-2"><input type='submit' class="btn btn-primary" value='Редактор пользователей'
                                            formaction="${pageContext.servletContext.contextPath}/admin/userRedactor"
                                            formmethod='get'></div>
                </div>
            </form>
        </div>
